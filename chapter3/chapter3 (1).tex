...
\item[\docfilehook{The double-slit experiment}{}] 
...
\item[\docfilehook{Orbital Filling: the aufbau principle}{}] 
...
\item[\docfilehook{Abbreviated Electron Configuration and orbital disgrams}{}] 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}\resizebox{.7\textwidth}{!}{\begin{tikzpicture}[rotate=0]
...
%
 ...
 \node[text width=14cm, fontscale=1] at (10em,-40em) { \begin{bf}\color{black}\bfseries\large Figure \ref{Fig:{\chapterlabel}\thefigurenewcounter} \end{bf} Ionic and atomic radius across the periodic table   };
...
\end{axis}
 ...
 \end{tikzpicture}\caption{Ionization energy graphed with respect to the atomic number}\end{center}\end{figure}
...
\end{tikzpicture}\end{center}\caption{Periodic properties across the periodic table}
 \end{figure*}
\newpage
