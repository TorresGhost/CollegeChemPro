...
\node[text width=5cm, fontscale=.1] at ([yshift=0.5cm]a.north) {\mytriangle{red}{\small Standing waves of a guitar}};
 ...
 \node (b) at (6cm,0) {\includegraphics[width=4.5cm, height=4.cm]{chapter3/figure1-18}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]b.south east) {\textsuperscript{\textcopyright} wikipedia} ;
...
\stepcounter{figurenewcounter}   \refstepcounter{figure}  \label{Fig:{\chapterlabel}\thefigurenewcounter}
     \begin{center}\begin{tikzpicture}[xscale=1,yscale=0.8, every node/.style={scale=1}]
            \node (a) at (0,0) {\includegraphics[width=8cm]{chapter3/figure1-21}} node[rotate=90, font=\tiny] at ([yshift=.5cm,xshift=.1cm]a.south east) {\textsuperscript{\textcopyright} wikipedia} ;
