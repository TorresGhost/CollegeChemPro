...
\lettrine[lines=4]{\color{black!45}I}{n} nature molecules can found in a myriad of different shapes. Some like carbon dioxide are one-dimensional or linear, others like methane have a three-dimensional shape. This chapter covers the analysis of the molecular shape as well as the study of advanced models of the chemical bond. More importantly, this chapter covers the reason why different molecules have different shapes: the molecular bond and the existence of lone pairs of electrons. You will be able to draw the connections between the atoms of a molecule.  The chemical bonds and the molecular geometry affect the properties of a molecule. At the end of the chapter we will address the polarity of molecules and you will understand the reasons why you use soap to get rid of oil while doing dished.
