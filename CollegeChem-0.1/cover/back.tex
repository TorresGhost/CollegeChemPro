...
The organization of the notes is based on 10 chapters and five parts, each made of two chapters. This organization is intended to help the reader digest the large content typically covered in a General Chemistry class. Every part ends with a review quiz that assesses the content of each part. 
Finally, the ultimately goal of this imperfect set of lectures is to save the student money, so that do not have to fully rely on a textbook. However, textbooks are curated and tested. With this said, this set of noted are made to complement and not replace any existing textbook.
\thispagestyle{empty}
\end{titlepage}
